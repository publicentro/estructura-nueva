...
use App\Http\Requests\MunicipioRequest as StoreRequest;
use App\Http\Requests\MunicipioRequest as UpdateRequest;
...
class MunicipioCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		*/
        ...
        $this->crud->setRoute("admin/municipio");
		...
		*/
        ...
        $this->crud->setColumnsDetails('region_id', [
             // 1-n relationship
